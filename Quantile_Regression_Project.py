...
def iteration_ridge_alpha(logalpha):
    ...
    plt.title('Evolution de l estimateur Ridge suivant la valeur \n'
              'du critËre de pÈnalisation alpha')


import ipywidgets as ip
ip.interact(iteration_ridge_alpha, logalpha=(-10, 10, 0.1))

## Nous avons fais une rÈgression mÈdiane sur variables catÈgorielles

# On remarque que les estimations de Rigde se trouvent toutes autour de la moyenne.
# Pour Lambda Ègale ‡ zÈro l'estimateur OLS donne la moyenne des observation.
# Notre rÈgression mÈdiane donne la mÈdiane des observations.
# Cela explique des rÈsultats presque similaires.